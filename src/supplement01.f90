...
open(UNIT=61, file=trim(cur_filename),FORM='UNFORMATTED', ACCESS='STREAM',STATUS='OLD',err=1001)
...
write(*,"('Opening binary file :', A)")   cur_filename
write(READLOG,"('Opening binary:', A)")   cur_filename
open(UNIT=62, file=trim(cur_filename),FORM='UNFORMATTED', ACCESS='STREAM',STATUS='OLD',err=1001)
