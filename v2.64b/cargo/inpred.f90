...
ver_num="version 2.64b cargo  (Dec 2010)"
!*****************************************
...
if (IsCargo .eq. 1 .and. IsProcessFlux .eq. 1) then
  write(*,*) 'generating cargo model flux flies for cm12 and cm18'
  call WriteCargo
  write(*,*) 'cargo files done'
  write(READLOG,*) 'generating  cargo cm12 and cm18 flux file ...done'
...
stop  'Report bugs to CE YI<yice@ufl.edu>'
...
write(*,"(A)")
write(*,"(A)") "                               CE YI                              " 
write(*,"(A)") "            Transport Theory Group at Univ. of Florida            "
write(*,"(A)") "          Nuclear and Radiological Engineering Department         " 
write(*,"(A)")
write(*,"(A)")
write(*,"(A)") "                    Use 'penmshxp -h' for more info               "
write(*,"(A)")
write(*,"(A)") "                         yice at ufl dot edu                      " 
write(*,"(A)")
write(*,"(A)")
write(*,"(A)")
...
write(*, "(' Copyright 2009 Ce Yi at University of Florida')" )
