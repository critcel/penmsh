...
ver_num="version 2.66c (Jan 2011)"
!*****************************************
...
write(*,"(A)")
write(*,"(A)") "                               CE YI                               " 
write(*,"(A)") "           CRiTCEL Group at the Georgia Institute of Technology    "
write(*,"(A)") "             Nuclear and Radiological Engineering Program          " 
write(*,"(A)")
write(*,"(A)")
write(*,"(A)") "                    Use 'penmshxp -h' for more info                "
write(*,"(A)")
write(*,"(A)") "                        yice at gatech dot edu                     " 
write(*,"(A)")
write(*,"(A)")
write(*,"(A)")
...
write(*, "(' Copyright 2011 Ce Yi at Georgia Inst of Tech ')" )
