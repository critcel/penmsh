...
open(UNIT=pltfile(filenum)%unit, FILE=trim(pltfile(filenum)%filename), FORM='UNFORMATTED', ACCESS='STREAM', &
     ERR=1001)
...
open(UNIT=pltfile(filenum)%tempunit, FILE='plt_temp', FORM='UNFORMATTED', ACCESS='STREAM', &
     ERR=1001)
